...
export const tezzKeywords: KeywordDoc[] = [
  // Edge & Service Keywords
  { label: 'service', kind: CompletionItemKind.Keyword, data: 1, detail: 'Service Definition', documentation: 'Defines an HTTP service natively on the edge.\n\nExample:\nservice MyAPI on 8080 {\n  route GET "/" { ... }\n}' },
  ...
  { label: 'karya', kind: CompletionItemKind.Keyword, data: 105, detail: 'Hinglish: Function (fn)', documentation: 'Hinglish equivalent of \'fn\'.' },
  { label: 'wapas', kind: CompletionItemKind.Keyword, data: 106, detail: 'Hinglish: Return', documentation: 'Hinglish equivalent of \'return\'.' },
  ...
  { label: 'se', kind: CompletionItemKind.Keyword, data: 117, detail: 'Hinglish: From', documentation: 'Hinglish equivalent of \'from\'.' },
